...
Version `3.0.0` is release-ready. Python 3.10+ is required. The public installation commands below become available after the official GitHub Release is published.
