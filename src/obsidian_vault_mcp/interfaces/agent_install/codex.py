"""Codex native plugin marketplace installer."""
...
PLUGIN_MANIFEST = Path("plugins") / "obsidian-literature" / ".codex-plugin" / "plugin.json"
...
def install(
    ...
    *,
    ...
    """Install the bundled marketplace and plugin with the native Codex CLI."""
    ...
    return install_native_plugin(
        ...
        marketplace_add_args=("plugin", "marketplace", "add", str(root), "--json"),
        plugin_install_args=("plugin", "add", PLUGIN_SELECTOR, "--json"),
        plugin_uninstall_args=("plugin", "remove", PLUGIN_SELECTOR, "--json"),
        marketplace_remove_args=("plugin", "marketplace", "remove", MARKETPLACE_NAME, "--json"),
        marketplace_records_key="marketplaces",
        marketplace_path_keys=("root",),
        plugin_records_key="installed",
        plugin_id_keys=("pluginId",),
