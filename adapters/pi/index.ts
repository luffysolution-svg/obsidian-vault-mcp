...
const tools = [
  ...
  ["literature_config_get", "Read the effective V2 vault configuration."],
  ["literature_config_validate", "Validate a V2 vault configuration."],
  ["literature_config_initialize", "Initialize the single V2 vault configuration file."],
  ...
  ["literature_paper_read", "Read bounded original evidence from one paper."],
  ["literature_analysis_context", "Collect structured evidence for a paper analysis."],
  ["literature_analysis_write", "Write a source-grounded Analysis note transactionally."],
  ["literature_uncertainty_list", "List structured paper uncertainties."],
  ["literature_uncertainty_resolve", "Resolve a paper uncertainty with audited evidence."],
  ["literature_rebuild_analysis_index", "Rebuild the deterministic Analysis index."],
  ["literature_retrieve", "Retrieve bounded evidence across an explicit paper scope."],
